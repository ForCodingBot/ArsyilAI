...
const GOOGLE_API_KEY = "AIzaSyAWslG7pbDSQiLCXisbw-4wl8Q76CqZ-uo";
    ...
    savedConversations.forEach(conversation => {
        const userMessageHtml = `
            <div class="message__content">
                <img class="message__avatar" src="images.jpeg" alt="User avatar">
        ...
        const responseHtml = `
           ...
           <div class="message__content">
                <img class="message__avatar" src="robot.jpeg" alt="Gemini avatar">
